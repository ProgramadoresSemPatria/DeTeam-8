...
const EventModal = ({ onSubmit }: EventModalProps) => {
  ...
  if (isMobile) {
    return (
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="bottom" className="h-[90vh] rounded-t-xl pt-6 pb-0 px-0 overflow-hidden">
          <div className="flex flex-col h-full">
            <div className="px-6 pb-4 border-b border-blue-100">
                ...
                <div className="space-y-3 pt-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      ...
                      className="w-full bg-blue-500 hover:bg-blue-600 flex items-center justify-center gap-2 transition-colors"
                    >
            ...
            <div className="sticky bottom-0 border-t border-blue-100 bg-white p-4 flex justify-between w-full">
              <Button
                type="button"
                variant="outline"
                onClick={() => setOpen(false)}
                className="flex-1 mr-2 text-blue-800 border-blue-300 hover:bg-blue-50"
              >
                Cancelar
              </Button>
              <Button
                type="button"
                className="flex-1 ml-2 bg-green-500 hover:bg-green-600 transition-colors"
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[650px] p-0 max-h-[90vh] overflow-hidden bg-white rounded-xl border border-blue-100">
        ...
        <div className="px-6 py-4 flex justify-end space-x-3 border-t border-blue-100 bg-white sticky bottom-0">
          <DialogClose asChild>
            <Button type="button" variant="outline" className="text-blue-800 border-blue-300 hover:bg-blue-50">
              Cancelar
            </Button>
          </DialogClose>
          <Button
