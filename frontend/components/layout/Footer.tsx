        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col md:hidden">
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
              {/* Developers Column */}
              <div>
                <h3 className="text-sm font-medium text-gray-900 mb-3 text-center sm:text-left">
                  Developers
                </h3>
                <ul className="space-y-2">
                  <li>
                    <Link
                      href="/docs"
                      className="text-sm text-gray-500 hover:text-gray-700 block text-center sm:text-left"
                    >
                      Documentação
                    </Link>
                  </li>
